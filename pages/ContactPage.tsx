...
export const ContactPage: React.FC = () => {
  ...
  const emails = ["srivallir16@gmail.com", "pavanikotipalli2@gmail.com"];
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="flex flex-col items-center text-center p-8 space-y-4">
            <div className="w-12 h-12 bg-primary-100 dark:bg-primary-900/30 text-primary-600 rounded-full flex items-center justify-center mb-2">
              <Icon variant="solid" size="md"><path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></Icon>
            </div>
            ...
            <div className="flex flex-col gap-3 mt-4 w-full">
              {emails.map((email) => (
                <div key={email} className="flex items-center gap-2 p-2 bg-neutral-100 dark:bg-neutral-800 rounded-md border border-neutral-200 dark:border-neutral-700">
                  <code className="text-sm font-mono px-2 flex-1 text-left">{email}</code>
                  <Button 
                    size="sm" 
                    variant="secondary" 
          ...
          <Card className="flex flex-col items-center text-center p-8 space-y-4">
            ...
            <div className="flex flex-col gap-2 w-full mt-4">
               <button 
                 ...
                 className="block w-full py-2 px-4 bg-neutral-50 hover:bg-neutral-100 dark:bg-neutral-800 dark:hover:bg-neutral-700 border border-neutral-200 dark:border-neutral-700 rounded-md text-sm font-medium transition-colors focus:outline-none text-center"
               >
                 Report an Issue
               </button>
               <button 
